...
public class BeatController {
    ...
    public ResponseEntity<DisplayBeatDto> findDtoById(@PathVariable("id") Long id,
        ...
        return ResponseEntity.ok(beatService.findDtoById(userId, id));
    }
    ...
    public ResponseEntity<Page<DisplayBeatDto>> getTopChart(
        ...
        return ResponseEntity.ok(beatService.getTopChart(nameFilter, filters, userId, pageable));
    }
    ...
    public void removeFromFavorite(@PathVariable("beatId") Long beatId,
                                   @AuthenticationPrincipal OAuth2User principal) {
        if (principal != null) {
    ...
    public ResponseEntity<List<Beat>> getDrafts(@AuthenticationPrincipal OAuth2User principal) {
        return principal == null ? null
                : ResponseEntity.ok(beatService.getDrafts(principal.getAttribute("sub")));
    }
    ...
    public ResponseEntity<List<Beat>> getSold(@AuthenticationPrincipal OAuth2User principal) {
        return principal == null ? null
                : ResponseEntity.ok(beatService.getSold(principal.getAttribute("sub")));
    }
    ...
    public ResponseEntity<Page<DisplayBeatDto>> getFreeBeats(@AuthenticationPrincipal OAuth2User principal,
                                                             Pageable pageable) {
        String userId = principal == null ? null : principal.getAttribute("sub");
        return ResponseEntity.ok(beatService.getFreeBeats(userId, pageable));
    }
    ...
    public ResponseEntity<Page<DisplayBeatDto>> findAllByGenre(@AuthenticationPrincipal OAuth2User principal,
                                                               ...
                                                               Pageable pageable) {
        String userId = principal == null ? null : principal.getAttribute("sub");
        return ResponseEntity.ok(beatService.findAllByGenre(userId, genre, pageable));
    }
    ...
    public ResponseEntity<Page<DisplayBeatDto>> findAllByTag(@PathVariable("tagId") Long tagId,
                                                             ...
                                                             Pageable pageable) {
        String userId = principal == null ? null : principal.getAttribute("sub");
        return ResponseEntity.ok(beatService.findAllByTag(userId, tagId, pageable));
    }
}